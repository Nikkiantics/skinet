        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<double>(type: "decimil(18, 2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipToAddressAppUserId = table.Column<string>(name: "ShipToAddress_AppUserId", type: "TEXT", nullable: true),
                    ShipToAddressAppUser = table.Column<string>(name: "ShipToAddress_AppUser", type: "TEXT", nullable: true),
                    DeliveryMethodId = table.Column<int>(type: "INTEGER", nullable: true),
                    Subtotal = table.Column<double>(type: "REAL", nullable: false),
                    Status = table.Column<string>(type: "TEXT", nullable: false),
                    PaymentIntenstId = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
